...
if __name__ == "__main__":
    ...
    pyramid_align_image_files = [
        ...
        'coms4732_hw1_data/master-pnp-prok-00100-00173a.tif',
        'coms4732_hw1_data/master-pnp-prok-00100-00178a.tif',
        'coms4732_hw1_data/master-pnp-prok-00200-00210a.tif'
